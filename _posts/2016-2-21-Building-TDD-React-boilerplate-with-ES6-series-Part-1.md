...
{% gist 2eb854ed8fd9e03be99b %}

...so if we type:

{% gist 0dc73e2a324c7e821a78 %}

...you'll have gulp's server task executed. It should give you an error:

{% gist c80f7c01969a358f9544 %}
...
{% gist a43c7c4ab4b7e021ddb6 %}

Output from `gulp server` command:

{% gist d2a34145eab42f6f0c93 %}
...
{% gist 12cbf5290301dbd5e2b0 %}

And install the module:

{% gist 3954d7432dc9a2c22c12 %}

Execute `clean` command:

{% gist 3c47b9b652978c70a95e %}
...
{% gist ccacda365e0de9603b66 %}

And run:

{% gist 4c17bb6b45df62dce007 %}
...
{% gist f8665d80ac274551269b %}

What do we see here? This part is really easy:

{% gist 6a6c2c977d286ee61227 %}
...
{% gist b39ed8c13aaee23e88ff %}
And how these changes look in our task:

{% gist 11de9f0484459a8d1351 %}

Execute gulp to test changes:

{% gist 85f322f5853e131de551 %}
